<link rel="stylesheet" href="{{ asset('component/bootstrap/dist/css/bootstrap.min.css') }}">
  ...
  <link rel="stylesheet" href="{{ asset('component/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="{{ asset('plugins/timepicker/bootstrap-timepicker.min.css') }}">
  <!-- Select2 -->
  <link rel="stylesheet" href="{{ asset('component/select2/dist/css/select2.min.css') }}">
